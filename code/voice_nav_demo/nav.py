...
class MoveBaseDoor():
    ...
    def goal(self, i):
        ...
        waypointsx = list([-0.598946750164, 2.74470472336, 2.63857078552, -0.595248103142])
        waypointsy = list([-1.05250120163, -0.159480959177, -1.15717506409, -0.0851126760244])

        waypointsaw = list([0.99908166902, 0.0353931596443, 0.0141917797499, 0.999373464239])
        waypointsw = list([-0.042846454089, 0.999373465853, 0.999899291623, -0.0353932051983])
